...
Latest local backup rehearsal evidence: `npm.cmd run backup:evidence` passed on `2026-08-10`. The isolated rehearsal database created a marker table/row, wrote `backups\rehearsals\sacco_app_backup_rehearsal-20260810-161957.dump`, dropped the table, restored the dump successfully, and removed the disposable Compose stack and volume.
