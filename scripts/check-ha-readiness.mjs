...
const checks = [
  ...
  [contents.runbook, "npm.cmd run ha:evidence", "HA runbook includes combined evidence command"],
  [contents.packageJson, "\"ha:redis-check\"", "package exposes Redis HA smoke script"],
  [contents.packageJson, "\"ha:evidence\"", "package exposes HA evidence script"],
