...
function renderReport(results) {
  return [
    ...
    "## Local Scope",
    "",
    "- Confirms documented release contracts for deployment, staging handoff, incident readiness, DR, secrets, database tuning, HA, data protection, Vite, i18n, accessibility, and repository hygiene.",
