...
const checks = [
  ...
  ["UAT readiness contract", "scripts/check-uat-readiness.mjs"],
  ["Load/soak readiness contract", "scripts/check-load-soak-readiness.mjs"],
  ["Incident readiness contract", "scripts/check-incident-readiness.mjs"],
  ["Hosted operations evidence contract", "scripts/check-hosted-operations-evidence.mjs"],
  ["Pilot launch decision contract", "scripts/check-pilot-launch-decision.mjs"],
  ["Security audit readiness contract", "scripts/check-security-audit-readiness.mjs"],
  ...
  ["Provider sandbox readiness contract", "scripts/check-provider-sandbox-readiness.mjs"],
...
function renderReport(results) {
  return [
    ...
    "## Local Scope",
    "",
    "- Confirms documented release contracts for deployment, staging handoff, UAT readiness, load/soak readiness, incident readiness, hosted operations evidence, pilot launch decision, security audit readiness, compliance readiness, DR, secrets, database tuning, HA, data protection, provider sandbox readiness, Vite, i18n, accessibility, accessibility audit readiness, and repository hygiene.",
